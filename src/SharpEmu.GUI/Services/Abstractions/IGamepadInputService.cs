...
internal interface IGamepadInputService
{
    ...
    /// <summary>Raised when Circle closes the in-game overlay.</summary>
    event Action? Cancel;

    /// <summary>Raised when Touch Pad / Xbox Back toggles the in-game overlay.</summary>
    ...
    /// ignore input because neither the launcher nor its overlay is active.
    /// </summary>
    ...
    bool Poll(bool isActive, bool isRunning, bool isOverlayOpen, int activePage);
}
