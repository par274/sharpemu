...
/// <summary>
/// The launcher's shell view-model: owns the active page (Library/Options) and
...
public partial class MainViewModel : ReactiveObject
{
    ...
    /// <summary>0 = Library, 1 = Options.</summary>
    ...
    /// <summary>Switches to the Library (0) or Options (1) page.</summary>
