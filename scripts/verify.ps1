...
function Invoke-FastLane {
    ...
    Invoke-Checked -Command "pwsh" -Arguments @("-NoProfile", "-File", (Join-Path $PSScriptRoot "test-runner-supervision.ps1"))
    Invoke-Checked -Command "pwsh" -Arguments @("-NoProfile", "-File", (Join-Path $PSScriptRoot "test-runner-supervision-process.ps1"))
